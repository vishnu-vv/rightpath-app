...
<div class="grid place-content-center mt-20 text-center px-4">
  <div class="personal-details grid place-content-center font-semibold">
    ...
    <div class="flex">
      <span>Passions: </span>
      <span>{$selectedPassionNames}</span>
    </div>
  </div>
  ...
  <div class="max-w-sm bg-white rounded-lg shadow-md mt-4 pt-4">
    ...
    <div class="p-5 pt-0">
      ...
      <button on:click={() => isOverlayOpen.set(true)} class="btn btn-primary w-full md:w-48 h-10 text-sm mx-auto font-semibold mt-8 grid place-content-center">
