<script lang="ts">
  ...
  import SkeletonCardLoader from "$lib/components/SkeletonCardLoader.svelte";
	import { query, showFilter } from '$lib/shared/stores/course';
...
{:else}
  <div class="courses">
    ...
    <div class="flex">
      <input class="bg-white border border-nuetral-200 rounded-sm px-2 w-3/4" placeholder="Search course title" type="text">
